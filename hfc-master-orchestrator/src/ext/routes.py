...
SAFETY_API_BASE    = os.getenv("SAFETY_API_BASE", "")  # e.g., https://safety-gpt-sds.onrender.com
SAFETY_API_KEY     = os.getenv("SAFETY_API_KEY", "")   # x-api-key for Safety
SLACK_BOT_TOKEN    = os.getenv("SLACK_BOT_TOKEN", "")  # xoxb-...
SLACK_DEFAULT_CHANNEL_ID = os.getenv("SLACK_DEFAULT_CHANNEL_ID", "")  # C...
